...
class Bonnotice extends Module
{
    ...
    protected function installSamples()
    {
        ...
        foreach ($languages as $language) {
            $item->description[$language['id_lang']] = '<p>Free shipping for billing over $75.00</p>';
            $item->code[$language['id_lang']] = '<span>Promo Code: #Summer</span>';
        }
