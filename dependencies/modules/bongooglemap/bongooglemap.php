...
class Bongooglemap extends Module
{
    ...
    {
        $settings = array(
            'BON_GOOGLE_KEY' => 'AIzaSyAerp48_2bYvYuHG8SR0NI3o1OCeTGNtgw',
    ...
    protected function addGooglemap()
    {
        ...
        foreach ($languages as $lang) {
            $googlemap->content[$lang['id_lang']] = Tools::getValue(
                'content_' . (int) $lang['id_lang'],
                isset($googlemap->content[$lang['id_lang']]) ? $googlemap->content[$lang['id_lang']] : ''
            );
        }
