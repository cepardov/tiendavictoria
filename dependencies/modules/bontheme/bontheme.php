...
class Bontheme extends Module
{
    public function __construct()
    {
        ...
        $this->alertText = $this->l('Required');
    }
    ...
    protected function getConfigurations()
    {
        $configurations = array(
            'THEME_ENABLE' => true,
            'THEME_STICKY_HEADER' => false,
            'THEME_STICKY_FOOTER' => false,
            'THEME_STICKY_CART' => false,
            'THEME_ENABLE_COLOR' => false,
            'THEME_ENABLE_DEMO' => false,
            'THEME_ENABLE_SETTINGS' => true,
            'THEME_COLOR' => '#444444',
            'THEME_ENABLE_PROMO' => false,
            'THEME_PROMO' => 'ECO-123456789123456',
            'THEME_PROMO_LINK' => '',
            'THEME_SELECTION_FONTS' => 'Popins'
        );
...
// This 
    ...
    {
        $bonfonts = array(
            array('fonts_id_option' => 'Popins', 'name' => 'Popins'), 
...
// 
    ...
    public function hookDisplayHeader()
    {
        ...
        Media::addJsDefL('alertText', $this->alertText);
    ...
    public function hookDisplayFooter()
    {
        $this->context->smarty->assign(array(
            'theme_settings' => Configuration::get('THEME_ENABLE_SETTINGS'),
