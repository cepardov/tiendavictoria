...
<div id="btn-bonorder" >
  {if !$configuration.is_catalog}
    {block name='product_quantity'}
        <a href="#bonorder" class="btn-bonorder btn {if !$product.add_to_cart_url}unvisible{/if}" data-toggle="modal" data-target="#bonorder-wrapper" >
        ...
        <form method="post" class="bonorder_form" action="#">
            <fieldset>
                ...
                <div class="submit">
                    ...
                    <input type="submit" class="btn btn-primary button button-small bonorder_send" value="{l s='Send' mod='bonorder'}"/>
                </div>
            </fieldset>
        </form>
        </div>
