        ...
        <li class="product-purchase-item {if $smarty.foreach.media.iteration == 1} active-item {/if}">
            <a class="product-item-inner" href="{$product.info.url|escape:'htmlall':'UTF-8'}">
                <div class="product-purchase-image-wrapper">
                    <img class="replace-2x img-responsive" src="{$product.info.cover.bySize.latest_purchase.url|escape:'htmlall':'UTF-8'}" alt="{$product.info.cover.legend|escape:'htmlall':'UTF-8'}" data-full-size-image-url="{$product.info.cover.large.url|escape:'htmlall':'UTF-8'}" />
                </div>
