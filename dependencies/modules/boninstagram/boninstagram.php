...
class Boninstagram extends Module
{
    ...
    protected function getModuleSettings()
    {
        $res = array(
            ...
            'BONINSTAGRAM_DISPLAY_CAROUSEL' => false,
            'BONINSTAGRAM_NB' => 4,
            'BONINSTAGRAM_SPEED' => 5000,
            'BONINSTAGRAM_MARGIN' => 20,
    ...
    public function hookDisplayHeader()
    {
        ...
        if (Configuration::get('BONINSTAGRAM_DISPLAY_CAROUSEL')) {
            ...
            Media::addJsDefL('BONINSTAGRAM_DISPLAY_CAROUSEL', Configuration::get(
                'BONINSTAGRAM_DISPLAY_CAROUSEL'
            ));
            ...
            Media::addJsDefL('BONINSTAGRAM_DOTS', Configuration::get('BONINSTAGRAM_DOTS'));
        }
    }
