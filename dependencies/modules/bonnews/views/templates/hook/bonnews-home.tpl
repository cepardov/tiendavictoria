    ...
    <div class="container">
        ...
        <section id="bonnews" class="bon-home">
            <div class="title-block revealOnScroll animated fadeInUp" data-animation="fadeInUp">
                ...
                <span>{l s='Stay ahead of the furniture trends with our news.' mod='bonnews'}</span>
                                ...
                                <div class="bonnews-item-description">
                                    ...
                                    {if isset($item.description) && $item.description}
                                        ...
                                        {if isset($item.author_name) && $item.author_name}
                                            <p class="author">
                                                <span>{l s='by' mod='bonnews'} <strong style="color: #3a3a3a;">{$item.author_name|escape:'htmlall':'UTF-8'}
            ...
            {if $display_carousel}
                ...
                {/foreach}
            {/if}
            <a class="bonnews-show-all revealOnScroll animated fadeInUp" data-animation="fadeInUp" href="{$link->getModuleLink('bonnews', 'main')|escape:'htmlall':'UTF-8'}">
                {l s='Show All News' mod='bonnews'}
            </a>
        </section>
    </div>
{/if}