                            ...
                            <li class="boncollection-item col-12 col-xs-12 col-md-6 col-lg-4">
                                ...
                                <div class="boncollection-item-description">
                                    {if isset($item.description) && $item.description}
                                        <p class="description">{$item.description|escape:'htmlall':'UTF-8' nofilter}</p>
            ...
            <nav class="pagination">
                <div class="col-md-4">
                    {block name='pagination_summary'}
                        {l s='Showing %from%-%to% of %total% item(s)' mod='boncollection' sprintf=['%from%' => $pagination.items_shown_from ,'%to%' => $pagination.items_shown_to, '%total%' => $pagination.total_items]}
                    {/block}
                </div>
                                        ...
                                        {else}
                                            <a
                                                ...
                                                {if $page.type === 'previous'}
                                                    <i class="material-icons">&#xE314;</i>{l s='Previous' mod='boncollection'}
