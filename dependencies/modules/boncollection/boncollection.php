...
class Boncollection extends Module
{
    ...
    protected function installSamples()
    {
        ...
        for ($i = 1; $i <= 2; ++$i) {
            ...
            foreach ($languages as $language) {
                $item->title[$language['id_lang']] = 'New colorful vape tips Sed ut perspiciatis rspiciatis!';
                ...
                $item->description[$language['id_lang']] = 'Sed ut perspiciatis unde omnis iste natus error sit tatem accusantium doloremque laudantium, totam rem aperiam.
                ccusantium doloremque laudantium, totam rem aperiam.';
            }
            $item->add();
            for ($j = 1; $j <= 2; ++$j) {
                ...
                foreach ($languages as $language) {
                    ...
                    $sub->description[$language['id_lang']] = 'Vulputate odio ut enim blandit. Dolor purus non enim praesent elementum. Felis imperdiet proin fermentum leo vel orci porta non pulvinar. Tempor orci dapibus ultrices in iaculis nunc sed.';
                }
                $sub->add();
            }
        }
