...
{block name='brand_miniature_item'}
  <li class="brand-page">
    <div class="brand-img col-xl-4 col-lg-3 col-xs-12"><a href="{$brand.url}"><img src="{$brand.image}" alt="{$brand.name}"></a></div>
    <div class="brand-infos col-xl-4 col-lg-4 col-xs-12">
      <p><a href="{$brand.url}">{$brand.name}</a></p>
      {$brand.text nofilter}
    </div>
    <div class="brand-products col-xl-4 col-lg-5 col-xs-12">
