...
{*                                    <p class="h5 text-uppercase">{l s='Download' d='Shop.Theme.Actions'}</p>*}
                                    {foreach from=$product.attachments item=attachment}
                                        <div class="attachment">
                                            <h2><a href="{url entity='attachment' params=['id_attachment' => $attachment.id_attachment]}">{$attachment.name}</a></h2>
                    ...
                    {foreach from=$product.extraContent item=extra key=extraKey}
                            <div class="tab-pane fade in revealOnScroll animated  {$extra.attr.class}" id="extra-{$extraKey}" role="tabpanel" {foreach $extra.attr as $key => $val} {$key}="{$val}"{/foreach}>
    ...
    {block name='product_accessories'}
      {if $accessories}
        <section class="product-accessories clearfix">
          <h2 class="h2 text-uppercase revealOnScroll animated fadeInUp" data-animation="fadeInUp">{l s='You might also like' d='Shop.Theme.Catalog'}</h2>
            <span class="same-products-description revealOnScroll animated fadeInUp" data-animation="fadeInUp">{l s='Stay ahead of the fashion trends with our new selection.' d='Shop.Theme.Catalog'}</span>
          <div class="products">
