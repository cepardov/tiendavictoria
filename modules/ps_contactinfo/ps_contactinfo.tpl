...
<div data-animation="fadeInUp" class="revealOnScroll block-contact col-md-3 links wrapper animated fadeInUp">
    <a class="block-contact-logo hidden-sm-down" href="{$urls.base_url}">
<img class="logo" src="{$shop.logo}" alt="{$shop.name}">
    </a>
    <div class="title clearfix hidden-md-up" data-target="#footer_contact" data-toggle="collapse">
        <span class="h3 text-uppercase block-newsletter-title">{l s='Store information' d='Shop.Theme.Global'}</span>
